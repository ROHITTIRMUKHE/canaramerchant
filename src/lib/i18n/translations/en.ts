...
export const en: Translations = {
  ...
  pages: {
    qrManagement: {
      title: 'QR Management',
      subtitle: 'Generate and manage QR codes for your merchant accounts',
      configureQr: 'Configure QR Code',
      selectMerchant: 'Select merchant type and QR configuration',
      mainMerchant: 'Main Merchant',
      subMerchant: 'Sub-Merchant',
      qrType: 'QR Type',
      staticQr: 'Static QR',
      dynamicQr: 'Dynamic QR',
      staticQrDesc: 'Fixed UPI ID, unlimited uses',
      dynamicQrDesc: 'Unique per transaction',
    ...
    transactions: {
      ...
      subtitle: 'View and search all your UPI transactions',
      filters: 'Filters',
    ...
    reports: {
      ...
      subtitle: 'View and download your account statements',
    ...
    profileSettings: {
      ...
      subtitle: 'Manage your merchant profile and preferences',
      profileInfo: 'Profile Information',
      bankDetails: 'Bank Details',
      apiIntegration: 'API & Integration',
      securityPreferences: 'Security & Preferences',
      merchantBasicInfo: 'Merchant Basic Information',
      merchantIdentifiers: 'Merchant Identifiers',
    ...
    settlements: {
      ...
      subtitle: 'View cumulative and individual sub-merchant settlements',
    ...
    refundsDisputes: {
      ...
      subtitle: 'Manage refunds and resolve transaction disputes',
      refunds: 'Refunds',
      disputes: 'Disputes',
